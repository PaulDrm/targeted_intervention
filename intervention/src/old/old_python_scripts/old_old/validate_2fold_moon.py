...
def main(): 
    ...
    for i in range(args.num_fold):
        ...
        curr_fold_results.to_json(f"../app/results__test_openchat_intervention_{int(args.alpha)}_{args.num_heads}.json", orient='records', indent=4)
        ...
        print(f"Precision: {precision}, Recall: {recall} for fold {i} and alpha {args.alpha} and number of heads {args.num_heads}")
