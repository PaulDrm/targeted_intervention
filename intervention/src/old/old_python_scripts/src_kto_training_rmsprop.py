...
class CustomKTOTrainer(KTOTrainer):
    def create_optimizer(self):
        """
        Override the default optimizer creation to use RMSprop
        """
...
if __name__ == "__main__":
    ...
    kto_args.gradient_accumulation_steps = 1
    kto_args.per_device_train_batch_size = 1
    kto_args.per_device_eval_batch_size = 1
    ...
    kto_args.optim = "rmsprop_bnb_8bit"
