...
def main(): 
    ...
    top_heads, probes = get_top_heads(train_set_idxs, val_set_idxs, separated_activations, separated_labels, num_layers, num_heads, args.seed, args.num_heads, args.use_random_dir, specific_heads=[(13,0)]) #(13,0)]) #(14, 1)]) #[(31,14)])
    ...
    for layer in range(num_layers):
        ...
        for h in range(num_heads):
            ...
            directory ="../intervention_results/pca_bulk_results_c_1000/"
            curr_fold_results.to_json(f"{directory}results_test_openchat_intervention_no_train_{int(args.alpha)}_{args.layer}_{args.head}_fold_{i}.json", orient='records', indent=4)
            ...
            json_file_path = f'{directory}overall_results.json'
            ...
            with open(f'{directory}overall_results.txt', 'a') as f:
