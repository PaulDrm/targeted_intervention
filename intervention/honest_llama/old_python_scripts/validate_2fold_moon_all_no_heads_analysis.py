...
def main(): 
    ...
    parser.add_argument("--model_name", type=str, default='openchat/openchat_3.5', help='model name')
    ...
    df = pd.read_json("../datasets/requirements_data/dataframe_open_chat_cot_moon_06022024_attentions_gt.json")
    #df = pd.read_json("../requirements_data/dataframe_open_chat_cot_moon_09042024_attentions_gt.json")
    ...
    for req_id in df['req_id'].unique():
        ...
        temp_activations = df[df['req_id'] == req_id][column]
    ...
    for i in range(args.num_fold):
        ...
        def lt_modulated_vector_add(head_output, layer_name, start_edit_location='lt'): 
                ...
                for head, direction, proj_val_std in interventions[layer_name]:
                    ...
                    #print(padded_direction.shape)
                    #print(direction_to_add)
                    #print(padded_direction)
                    #print(direction_to_add == padded_direction)
        ...
        curr_fold_results.to_json(f"../intervention_results/requirements_data/results_test_openchat_intervention_no_train_{int(args.alpha)}_{args.layer}_{args.head}_fold_{i}.json", orient='records', indent=4)
        ...
        with open('../intervention_results/requirements_data/overall_results.txt', 'a') as f:
