...
def main(): 
    ...
    #     if df[df[id_column] == req_id]['predict'].nunique() > 1: 
    #         print(req_id)
    ...
    for i in range(args.num_fold):
        ...
        curr_fold_results.to_json(f"{args.output_path}/results_test_openchat_intervention_no_train_{int(args.alpha)}_{args.layer}_{args.head}_fold_{i}.json", orient='records', indent=4)
