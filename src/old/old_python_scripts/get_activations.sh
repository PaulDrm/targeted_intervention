python get_activations.py openchat tqa_gen --device 0
#python get_activations.py openchat tqa_mc2 --device 0
#python get_activations.py openchat tqa_gen_end_q --device 0

#python get_activations.py llama2_chat_7B tqa_mc2 --device 0
#python get_activations.py llama2_chat_7B tqa_gen_end_q --device 0

#python get_activations.py honest_llama_7B tqa_mc2 --device 0 
